...
class NavBar extends Widget
{
    ...
    public function init()
    {
        ...
        echo Html::beginTag('div', ['class'=>'navbar-minimize']);
        echo Html::beginTag('button', [
            'id'=>"minimizeSidebar",
            'class'=>'btn btn-warning btn-fill btn-round btn-icon']);
                echo Html::tag('i','',['class'=>'fa fa-ellipsis-v visible-on-sidebar-regular']);
                echo Html::tag('i','',['class'=>'fa fa-angle-double-right visible-on-sidebar-mini']);
